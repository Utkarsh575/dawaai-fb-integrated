        ...
        ScrollView{
            ...
            VStack{
                ...
                VStack{
                    ...
                    Text(medicine.name).font(.system(size: 30,weight: .semibold)).frame(maxWidth: .infinity ,alignment : .leading).padding(.leading , 5);
                    
                    
                    Text("Strength").font(.system(size: 15,weight: .medium)).frame(maxWidth: .infinity ,alignment : .leading).padding(.leading , 5);
                    
                    
                    Text("\(String(medicine.strength)) \(String(medicine.strengthUnit))").font(.system(size: 30,weight: .semibold)).frame(maxWidth: .infinity ,alignment : .leading).padding(.leading , 5);
                    
                    Text("Next reminder").font(.system(size: 15,weight: .medium)).frame(maxWidth: .infinity ,alignment : .leading).padding(.leading , 5);
                    
                    
                    Text(getTimeFromTimestamp(timestamp: medicine.nextDoseTime.timeIntervalSince1970)).font(.system(size: 25,weight: .semibold)).frame(maxWidth: .infinity ,alignment : .leading).padding(.leading , 5);
